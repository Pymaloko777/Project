...
Приложение представляет собой программу для совершения вычислительных действий над одним или парой чисел. Будут реализованы следующие функции: 
...
Б) Действия над двумя числами (сложение, вычитание, умножение, деление, возведение в степень, степенью будет второе число, извлечение корня, степенью корня будет второе число ). 
